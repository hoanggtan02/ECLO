<?php
    ...
    $app->router("/admin/device-information", 'GET', function($vars) use ($app, $jatbi, $setting) {
        $vars['router'] = 'device_information';
        $vars['title'] = $jatbi->lang("Thông tin thiết bị");
        $apiData = [
    ...
    $app->router("/admin/system-information", 'GET', function($vars) use ($app, $jatbi, $setting) {
        $vars['router'] = 'system_information';
